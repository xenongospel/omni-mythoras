...
A chosen Principal starts from a base configuration that may later be replaced or crafted further. Shape of that configuration is OPEN. Do not add a second layer called Pinnacle Evolution.
